...
| 2026-09-21 | Исправлено поле международного телефона: выбор кода страны больше не вытесняет ввод номера. Англоязычный пользовательский интерфейс дополнен переводами, включая формы, оплату, материалы и названия стран. |
| 2026-09-21 | В селекторе международного телефона добавлены локальные SVG-флаги: они отображаются одинаково на всех устройствах и не зависят от поддержки emoji-шрифтов. |
