...
export default function HealthHelpersScreen({ onNavigate }) {
  ...
  return (
    <section className="screen" id="screen-health-helpers-detail">
      ...
      <header className="flex items-center gap-3 py-3 border-b border-gray-100 shrink-0">
        <button
      ...
      <div className="bg-gray-100 rounded-xl p-1 flex w-full gap-1" style={{ marginTop: "16px", marginBottom: "16px" }}>
        <button
          type="button"
          onClick={() => setActiveTab("aromatherapy")}
          className={`flex-1 py-3 text-sm font-semibold rounded-lg transition-all text-center ${
