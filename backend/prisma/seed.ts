...
async function seedProducts() {
  const products = [
    { id: 101, name: 'Чугунная гиря 8 кг', price: 3200, description: 'Оптимальный вес для дыхательной практики на 7 точек', category: 'Инструменты', imageKey: '/kettlebell-8.jpg' },
    { id: 102, name: 'Чугунная гиря 12 кг', price: 4500, description: 'Для продвинутых тренировок гиревого дыхания на 10 точек', category: 'Инструменты', imageKey: '/kettlebell-12.jpg' },
...
async function seedContent() {
  // Абзацы в body разделяются пустой строкой — фронтенд разбивает текст по ним.
  const articles = [
    {
      id: 1,
      title: 'Анатомия дыхания: как гиря помогает легким',
      description: 'Подробный разбор механики дыхания при кинезиотерапевтических нагрузках.',
      readTime: '5 мин',
      body: [
    ...
    },
    {
      ...
      description: 'Изучение связи между тонусом мышц стопы и правильной походкой.',
      readTime: '8 мин',
      body: [
